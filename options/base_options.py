...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # model parameters
        parser.add_argument('--model', type=str, default='Mamba', help='chooses which model to train [parse|enhance]')
        ...
        parser.add_argument('--scale_factor', type=int, default=8, help='upscale factor for HibriMambaBlock')
